               ...
               <div class="row">
                    <div class="col-lg">
                         ...
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <form action="/PurchasingOrder/Save" method="post">
                                        <div class="row">
                                             <div class="col">
                                        ...
                                        <div class="row align-items-center">
                                             ...
                                             <input type="text" class="form-control" id="soDetailId" name="soDetailId"
                                                  hidden>
                                             ...
                                             <div class="col-1  ">
                                                  <a name="popup" id="popup" class="btn btn-success align-bottom "
                                                       role="button"
                                                       onclick="window.open('/PurchasingOrder/popupitem', 'Add Items', 'width=640px,height=480px')">+</a>
                                             </div>
                                        </div>
                                        <div class="row d-flex justify-content-around">
                                             <button id="add" onclick="return tambah()" class="btn btn-primary"
                                                  role="button">Add</button>
                                             <button id="save" onclick="return save()" class="btn btn-success"
