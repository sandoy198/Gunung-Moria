                                   ...
                                   <table class="table table-bordered">
                                        ...
                                        <tbody>
                                             ...
                                             <tr>
                                                  <td><?= $i++; ?></td>
                                                  <td><a href=""
                                                            onclick="tambah('<?= $u->id; ?>','<?= $u->name; ?>','<?= $u->category; ?>','<?= $u->jumlah; ?>','<?= $u->item_id; ?>')"><?= $u->name; ?></a>
                                                  </td>
...
<?= $this->section('js') ?>
<script>
function tambah(a, b, c, d, e) {
     opener.document.forms[0].soDetailId.value = a;
     opener.document.forms[0].name.value = b;
     opener.document.forms[0].category.value = c;
     opener.document.forms[0].jumlah.value = d;
     opener.document.forms[0].id.value = e;
